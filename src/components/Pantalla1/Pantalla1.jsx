...
export const Pantalla1 = () => {
  return (
    <div className='vh'>
        ...
        <div className='derecha2 infiniteanimation2'>Well keep your books up to date and confirm categorization along the way so you can take advantage of important tax write-offs.</div>
